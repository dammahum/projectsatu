            ...
            <input type="hidden" name="id" value="<?= $id ?>">
              <!-- <div class="box-body"> -->
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="tanggal_lahir" value="<?php echo $row['tanggal_lahir']; ?>" class="form-control tanggal" placeholder="Tanggal Lahir">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Alamat</label>
                  <div class="col-sm-10">
                    <input type="text" name="alamat" value="<?php echo $row['alamat']; ?>" class="form-control" placeholder="Alamat">
                  </div>
                </div>
                <div class="form-group">
